...
print('''
     ...
     ____.________  _________   ___ ___  _______   ________                
    |    |\______ \ \_   ___ \ /   |   \ \      \  \_____  \  ____ ___  ___
    |    | |    |  \/    \  \//    ~    \/   |   \  /  ____/ /    \\  \/  /
/\__|    | |    `   \     \___\    Y    /    |    \/       \|   |  \>    < 
\________|/_______  /\______  /\___|_  /\____|__  /\_______ \___|  /__/\_ \
                  \/        \/       \/         \/         \/    \/      \/
...
with open("bin/sku-packages-chn.json", encoding="utf-8") as sku:
    skupackages = json.load(sku)
with open("bin/songdb-chn.json", encoding="utf-8") as db:
    songdb = json.load(db) 
